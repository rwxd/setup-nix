      ...
      bottom = {
        ...
        blocks = [
          ...
          }
          {
            ...
            format_alt =
              " $icon_swap $swap_free.eng(w:3,u:B,p:M)/$swap_total.eng(w:3,u:B,p:M)($swap_used_percents.eng(w:2)) ";
            interval = 30;
            warning_mem = 70;
            critical_mem = 90;
          }
      ...
      top = {
        ...
        blocks = [
          ...
          }
          {
            block = "net";
            format =
              " $icon {$signal_strength $ssid $frequency|Wired connection} via $device ";
            click = [{
              button = "left";
