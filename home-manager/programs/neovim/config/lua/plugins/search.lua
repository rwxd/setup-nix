  ...
  },
  {
    ...
    keys = {
        ...
        },
        {
            ...
            desc = "List the results of the last search (previous telescope picker)",
        },
        {
            "<C-S-p>",
            function() require('telescope.builtin').commands() end,
            desc = "Find commands and run them on enter",
        },
    },
  },
}
